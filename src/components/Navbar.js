    ...
    return (
       <div>
         <nav className="navbar navbar-expand-lg navbar-light bottom-border">
         	<a className="navbar-brand orange hvr-grow" href="#index">Project Budget Manager</a>
         	<div className="navbar-nav w-100">
         		<a className="nav-item nav-link ml-auto hvr-grow" href="#Profile">Name Lastname</a>
            {/* <a className="nav-item nav-link" onClick={this.toggle} id="Notifications" >Notifications</a> */}
            {/* <a className="nav-item nav-link" id="Notifications" >Notifications</a> */}
            ...
            {/* <Popover
              ...
              <PopoverBody>
                ...
                />
         		...
         		<a className="nav-item nav-link hvr-grow" href="#List">Database</a>
         		<a className="nav-item nav-link hvr-grow" href="#Index">Log out</a>
         	</div>
         </nav>
      </div>
    )
